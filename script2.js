...
var data = [
  { message: 'Hii ! i am Aasif and You?', sender: 'agent', createdAt: '', },
  { message: 'My self Sajid', sender: 'user', createdAt: '' },
  { message: 'How are you sajid', sender: 'agent', createdAt: '' },
  { message: 'I am good, how about you?', sender: 'user', createdAt: '' },
  { message: 'I am good,thanks for asking', sender: 'agent', createdAt: '' },
  { message: 'How can I help you today?', sender: 'agent', createdAt: '' },
  { message: 'actually, I want to know about your day', sender: 'user', createdAt: '' },
]
